            ...
            <div style={{ maxWidth: "1400px", margin: "0 auto", position: "relative", zIndex: 1 }}>
                ...
                >
                    ...
                    <div style={{ flex: 1, padding: "1.5rem", borderRight: "1px solid rgba(8, 8, 8, 0.08)", background: "#FFFFFF" }}>
                        <span style={{ fontFamily: "var(--font-mono)", fontSize: "0.6rem", color: "#F04E23", border: "1px solid rgba(240, 78, 35, 0.25)", borderRadius: "4px", padding: "0.2rem 0.5rem", display: "inline-block" }}>
                            01
                        </span>
                        ...
                        <div style={{ marginTop: "1.5rem", display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                            <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", fontFamily: "var(--font-mono)", fontSize: "0.55rem", color: "rgba(8, 8, 8, 0.35)", textTransform: "uppercase" }}>
                                <span style={{ color: "#F04E23" }}>·</span> Core Web Vitals 100
                            </div>
                            <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", fontFamily: "var(--font-mono)", fontSize: "0.55rem", color: "rgba(8, 8, 8, 0.35)", textTransform: "uppercase" }}>
                                <span style={{ color: "#F04E23" }}>·</span> SEO técnico integrado
                            </div>
                        </div>
                    </div>
                    ...
                    <div style={{ flex: 1, padding: "1.5rem", borderRight: "1px solid rgba(8, 8, 8, 0.08)", background: "#FFFFFF" }}>
                        ...
                        <div style={{ marginTop: "1.5rem", display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                            <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", fontFamily: "var(--font-mono)", fontSize: "0.55rem", color: "rgba(8, 8, 8, 0.35)", textTransform: "uppercase" }}>
                                <span style={{ color: "#F04E23" }}>·</span> LOCAL · EN
                            </div>
                            <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", fontFamily: "var(--font-mono)", fontSize: "0.55rem", color: "rgba(8, 8, 8, 0.35)", textTransform: "uppercase" }}>
                                <span style={{ color: "#F04E23" }}>·</span> +TRÁFICO ORGÁNICO
                            </div>
                        </div>
                    </div>
                    ...
                    <div style={{ flex: 1, padding: "1.5rem", background: "#FFFFFF" }}>
                        ...
                        <div style={{ marginTop: "1.5rem", display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                            <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", fontFamily: "var(--font-mono)", fontSize: "0.55rem", color: "rgba(8, 8, 8, 0.35)", textTransform: "uppercase" }}>
                                <span style={{ color: "#F04E23" }}>·</span> BÚSQUEDA + DISPLAY
                            </div>
                            <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", fontFamily: "var(--font-mono)", fontSize: "0.55rem", color: "rgba(8, 8, 8, 0.35)", textTransform: "uppercase" }}>
                                <span style={{ color: "#F04E23" }}>·</span> RETARGETING INCLUIDO
                            </div>
                        </div>
                    </div>
                </motion.div>
