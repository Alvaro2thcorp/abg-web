...
export default function Precios() {
    ...
    const tiers = [
        ...
        },
        {
            ...
            desc: "Web + SEO + Redes sociales. La forma en que trabajamos por defecto.",
            features: [
                "Web premium a medida incluida",
                "Visibilidad orgánica + posicionamiento EN",
                "Gestión de redes sociales",
                "Meta Ads opcional ES/EN/FR",
                    ...
                    {tiers.map((tier, i) => (
                        <motion.div
                            ...
                            style={{
                                ...
                                border: tier.accent ? "1px solid rgba(209, 65, 36, 0.3)" : "1px solid rgba(8, 8, 8, 0.08)",
                                borderRadius: "20px",
                                padding: "2rem",
                                display: "flex",
                        ...
                        >
                                ...
                                <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "0.6rem" }}>
                                    {tier.features.map((feature, idx) => (
                                        <li key={idx} style={{
                                            ...
                                            <div style={{ width: "5px", height: "5px", background: "#D14124", borderRadius: "50%", flexShrink: 0, marginTop: "6px" }} />
                                            {feature}
                                        </li>
                                    ))}
                                </ul>
                            ...
                            <a
                                ...
                                style={{
                                    ...
                                    background: tier.accent ? "#D14124" : "transparent",
