...
const LightPillar: React.FC<LightPillarProps> = ({
  ...
  useEffect(() => {
    ...
    const qualitySettings: Record<string, { iterations: number; waveIterations: number; pixelRatio: number; precision: "highp" | "mediump" | "lowp"; stepMultiplier: number; }> = {
    ...
    const fragmentShader = `
      ...
      void main() {
        ...
        // Luminance-based alpha for transparency
