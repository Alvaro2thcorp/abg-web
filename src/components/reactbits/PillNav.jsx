  ...
  return (
    <div className="pill-nav-container">
      <nav className={`pill-nav ${className}`} aria-label="Primary" style={cssVars}>
        <a className="pill-logo" href="/" aria-label="Inicio" onMouseEnter={handleLogoEnter} ref={el => { logoRef.current = el; }}>
        ...
        {ctaButton && <div className="pill-cta-wrapper desktop-only">{ctaButton}</div>}

        <button className="mobile-menu-button mobile-only" onClick={toggleMobileMenu} aria-label="Abrir menú" ref={hamburgerRef}>
      ...
      <div className="mobile-menu-popover mobile-only" ref={mobileMenuRef} style={cssVars}>
        <ul className="mobile-menu-list">
          ...
          {ctaButton && <li style={{ marginTop: '8px' }}>{ctaButton}</li>}
        </ul>
      </div>
    </div>
  );
