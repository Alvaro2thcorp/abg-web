...
const techs = [
  ...
  {
    node: (
      <svg viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: "36px", width: "auto" }}>
        <g fill="rgba(242,240,237,0.5)">
  ...
  {
    node: (
      <svg viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: "34px", width: "auto" }}>
        <path fill="rgba(242,240,237,0.5)" d="M64 3.941C30.746 3.941 3.941 30.746 3.941 64S30.746 124.059 64 124.059 124.059 97.254 124.059 64 97.254 3.941 64 3.941zM8.458 64c0-7.865 1.756-15.329 4.877-22.04l26.866 73.599C22.274 106.944 8.458 86.94 8.458 64zM64 119.542c-5.296 0-10.407-.765-15.261-2.171L64.96 71.154l16.609 45.509a5.71 5.71 0 0 0 .415.785 55.406 55.406 0 0 1-17.984 3.094z"/>
      </svg>
    ),
    title: "WordPress",
  },
  {
    node: (
      <svg viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: "40px", width: "auto" }}>
        <path fill="rgba(242,240,237,0.4)" d="M116.5 10H11.5C5.7 10 1 14.7 1 20.5v65c0 5.8 4.7 10.5 10.5 10.5H46l-5 22 28-22h47.5c5.8 0 10.5-4.7 10.5-10.5v-65C127 14.7 122.3 10 116.5 10z"/>
