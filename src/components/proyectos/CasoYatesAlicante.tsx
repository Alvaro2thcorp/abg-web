...
export default function CasoYatesAlicante() {
  return (
    <div style={{ background: '#080808', color: '#F2F0ED', fontFamily: 'var(--font-body)' }}>
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto', width: '100%', position: 'relative', zIndex: 10 }}>
          ...
          <div className="hero-flex" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', flexWrap: 'wrap', gap: '3rem' }}>
            ...
            <motion.div variants={fadeInUp} className="hero-data-col" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', alignItems: 'flex-end', textAlign: 'right' }}>
              <div style={{ display: 'flex', flexDirection: 'column' }}>
                <span style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: '2rem', lineHeight: 1, color: '#F2F0ED' }}>Web + SEO + Ads</span>
          ...
          <motion.div variants={fadeInUp} style={{ marginTop: '4rem', paddingTop: '2rem', borderTop: '1px solid rgba(242, 240, 237, 0.08)', display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
            {["Astro 5", "React", "Tailwind CSS"].map((tech) => (
              <span key={tech} style={{ border: '1px solid rgba(242, 240, 237, 0.1)', borderRadius: '100px', padding: '0.4rem 1rem', fontFamily: 'var(--font-mono)', fontSize: '0.55rem', color: 'rgba(242, 240, 237, 0.4)', textTransform: 'uppercase' }}>
                {tech}
              </span>
            ))}
          </motion.div>
        ...
        <div className="reto-grid" style={{ maxWidth: '1400px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '5rem', alignItems: 'start' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            {[
              ...
              >
                <span style={{ fontFamily: 'var(--font-mono)', fontSize: '0.55rem', color: 'rgba(8, 8, 8, 0.2)', display: 'block', marginBottom: '0.5rem' }}>{item.num}</span>
                <h3 style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: '1.05rem', color: '#080808', marginBottom: '0.5rem', marginTop: 0 }}>{item.title}</h3>
                <p style={{ fontFamily: 'var(--font-body)', fontWeight: 300, fontSize: '0.875rem', color: 'rgba(8, 8, 8, 0.5)', lineHeight: 1.75, margin: 0 }}>
                  {item.desc}
                </p>
              </motion.div>
            ))}
          ...
          <div className="solucion-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1.5rem' }}>
            {[
              ...
              >
                ...
                <p style={{ fontFamily: 'var(--font-body)', fontWeight: 300, fontSize: '0.875rem', color: 'rgba(242, 240, 237, 0.4)', lineHeight: 1.75, margin: 0 }}>
                  {item.desc}
                </p>
              </motion.div>
            ))}
      ...
      >
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
            ...
            {[
              ...
              <div key={idx} style={{ background: '#080808', padding: '2.5rem 1.5rem', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
                <div style={{ display: 'flex', alignItems: 'baseline', gap: '4px' }}>
                  <span style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: 'clamp(2rem, 4vw, 3.5rem)', color: '#F2F0ED', lineHeight: 1 }}>
                    {metric.val}
                  </span>
                  {metric.suffix && (
                ...
                <span style={{ fontFamily: 'var(--font-mono)', fontSize: '0.52rem', color: 'rgba(242, 240, 237, 0.25)', textTransform: 'uppercase', marginTop: '0.75rem', letterSpacing: '0.1em' }}>
                  {metric.label}
                </span>
              </div>
            ))}
          ...
          <p style={{ marginTop: '1.5rem', textAlign: 'center', fontFamily: 'var(--font-mono)', fontSize: '0.52rem', color: 'rgba(242, 240, 237, 0.2)', fontStyle: 'italic' }}>
      ...
      >
        <div style={{ maxWidth: '680px', margin: '0 auto' }}>
          ...
          <p style={{ fontFamily: 'var(--font-body)', fontWeight: 300, fontSize: '1rem', color: 'rgba(8, 8, 8, 0.5)', lineHeight: 1.8, marginBottom: '2.5rem' }}>
          ...
          <div className="cta-buttons" style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <a 
              ...
              style={{ padding: '1.1rem 2.5rem', border: '1.5px solid rgba(8, 8, 8, 0.15)', color: 'rgba(8, 8, 8, 0.6)', fontFamily: 'var(--font-display)', fontWeight: 600, borderRadius: '100px', textDecoration: 'none', transition: 'all 0.3s' }}
